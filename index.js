...
*/
function temperatureCtoF(degrees) {
...
function getCarInfoByIndex(inventory, index) {
  return inventory[index].car_make;
}
console.log(getCarInfoByIndex(inventory, 7))


///other array taken from the data folder
const exports = [
  { id: 1, car_make: "Lincoln", car_model: "Navigator", car_year: 2009 },
  { id: 2, car_make: "Mazda", car_model: "Miata MX-5", car_year: 2001 },
  { id: 3, car_make: "Land Rover", car_model: "Defender Ice Edition", car_year: 2010 },
...
console.log(getLastCarInfo(exports)); 
...
function getModelYears(array) {
  for (var i = 0; i < array.length; i++) {
    console.log(array[i].car_year); 
  }
}
getModelYears(exports);
...
function getCarInfoById(array, id) {
  for(var i = 0; i < array.length; i++) {
    let carID = id; 
    if (carID === array[i].id) {
      console.log(`This is a ${array[i].car_make} ${array[i].car_model}`);
    }
  }
}
getCarInfoById(exports, 43); 
